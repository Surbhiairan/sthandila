function checkWidth(e) {
    $(window).width() <= 991 && ($(".dropdown-submenu a").on("click", function(e) {
        ...
        $(".navbar").removeClass("active"), $(".navbar-toggler-icon").removeClass("active"), $("body").removeClass("offcanvas--open")
    }))
}

function navMenu() {
    $('[data-toggle="navbarToggler"]').click(function() {
        $(".navbar").toggleClass("active"), $("body").toggleClass("offcanvas--open")
    }), $(".navbar-toggler").click(function(e) {
        $(".navbar-toggler-icon").toggleClass("active"), e.stopPropagation()
    });
    var t = $(".navbar-sticky");
...
function addZero(e, t) {
    ...
    S.fn = S.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || y(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e) i = s[t], s !== (n = e[t]) && (c && n && (S.isPlainObject(n) || (o = Array.isArray(n))) ? (r = o ? (o = !1, i && Array.isArray(i) ? i : []) : i && S.isPlainObject(i) ? i : {}, s[t] = S.extend(c, r, n)) : void 0 !== n && (s[t] = n));
        return s
    }, S.extend({
    ...
    var p = function(i) {
        ...
        try {
            L.apply(t = I.call(y.childNodes), y.childNodes), t[y.childNodes.length].nodeType
        } catch (i) {
            L = {
        ...
        function re(e, t, i, n) {
            ...
            if (!n && ((t ? t.ownerDocument || t : y) !== k && _(t), t = t || k, T)) {
                if (11 !== f && (l = G.exec(e)))
                    if (o = l[1]) {
                        if (9 === f) {
                        ...
                        if ((o = l[3]) && p.getElementsByClassName && t.getElementsByClassName) return L.apply(i, t.getElementsByClassName(o)), i
                    ...
                    if (1 !== f) u = t, d = e;
                        ...
                        d = c.join(","), u = Z.test(e) && ge(t.parentNode) || t
                    }
                    if (d) try {
                        return L.apply(i, u.querySelectorAll(d)), i
                    } catch (e) {} finally {
        ...
        for (e in p = re.support = {}, o = re.isXML = function(e) {
                ...
                return n !== k && 9 === n.nodeType && n.documentElement && (s = (k = n).documentElement, T = !o(k), y !== k && (i = k.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", ne, !1) : i.attachEvent && i.attachEvent("onunload", ne)), p.attributes = le(function(e) {
                ...
                }, a = [], v = [], (p.qsa = K.test(k.querySelectorAll)) && (le(function(e) {
                    ...
                    p.disconnectedMatch = d.call(e, "*"), d.call(e, "[s!='']:x"), a.push("!=", q)
                ...
                if ((e.ownerDocument || e) !== k && _(e), t = t.replace(B, "='$1']"), p.matchesSelector && T && !C[t + " "] && (!a || !a.test(t)) && (!v || !v.test(t))) try {
                    var i = d.call(e, t);
                    if (i || p.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i
                } catch (e) {}
                return 0 < re(t, k, null, [e]).length
            }, re.contains = function(e, t) {
                return (e.ownerDocument || e) !== k && _(e), m(e, t)
                ...
                filter: {
                        ...
                        return 1 === g && 0 === v ? function(e) {
                            ...
                            if (d) {
                                ...
                                if (l = [y ? d.firstChild : d.lastChild], y && f) {
                                    for (p = (a = (n = (o = (r = (s = d)[S] || (s[S] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] || [])[0] === E && n[1]) && n[2], s = a && d.childNodes[a]; s = ++a && s && s[c] || (p = a = 0) || l.pop();)
                                    ...
                                    for (;
                                        (s = ++a && s && s[c] || (p = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== u : 1 !== s.nodeType) || !++p || (f && ((o = (r = s[S] || (s[S] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[h] = [E, p]), s !== e)););
                    ...
                    PSEUDO: function(e, r) {
                        ...
                        return s[S] ? s(r) : 1 < s.length ? (t = [e, e, "", r], w.setFilters.hasOwnProperty(e.toLowerCase()) ? ae(function(e, t) {
                            for (var i, n = s(e, r), o = n.length; o--;) e[i = j(e, n[o])] = !(t[i] = n[o])
                        }) : function(e) {
                            return s(e, 0, t)
                        }) : s
                    }
                ...
                pseudos: {
                    ...
                    lang: ae(function(i) {
                        return V.test(i || "") || re.error("unsupported lang: " + i), i = i.replace(J, ee).toLowerCase(),
                            function(e) {
                                var t;
                                do {
                    ...
                    for (; e = e[l];)
                        if (1 === e.nodeType || u)
                            if (o = (r = e[S] || (e[S] = {}))[e.uniqueID] || (r[e.uniqueID] = {}), c && c === e.nodeName.toLowerCase()) e = e[l] || e;
                                ...
                                if ((n = o[d]) && n[0] === E && n[1] === f) return s[2] = n[2];
        ...
        function xe(p, h, g, v, m, e) {
            return v && !v[S] && (v = xe(v)), m && !m[S] && (m = xe(m, e)), ae(function(e, t, i, n) {
                var o, r, s, a = [],
                    l = [],
                    c = t.length,
                    d = e || function(e, t, i) {
                    ...
                    f = g ? m || (e ? p : c || v) ? [] : t : u;
                if (g && g(u, f, i, n), v)
                    for (o = we(f, l), v(o, [], i, n), r = o.length; r--;)(s = o[r]) && (f[l[r]] = !(u[l[r]] = s));
                if (e) {
                    if (m || p) {
                        if (m) {
                        ...
                        for (r = f.length; r--;)(s = f[r]) && -1 < (o = m ? j(e, s) : a[r]) && (e[o] = !(t[o] = s))
                    }
                } else f = we(f === t ? f.splice(c, f.length) : f), m ? m(null, t, f, n) : L.apply(t, f)
            })
        }
        ...
        return ve.prototype = w.filters = w.pseudos, w.setFilters = new ve, h = re.tokenize = function(e, t) {
            ...
            for (s = e, a = [], l = w.preFilter; s;) {
                for (r in i && !(n = F.exec(s)) || (n && (s = s.slice(n[0].length) || s), a.push(o = [])), i = !1, (n = z.exec(s)) && (i = n.shift(), o.push({
                        value: i,
                        type: n[0].replace(R, " ")
            ...
            var i, v, m, y, b, n, o = [],
                ...
                s = C[e + " "];
            if (!s) {
                for (t || (t = h(e)), i = t.length; i--;)(s = _e(t[i]))[S] ? o.push(s) : r.push(s);
                (s = C(e, (v = r, m = o, y = 0 < m.length, b = 0 < v.length, n = function(e, t, i, n, o) {
                    var r, s, a, l = 0,
                        c = "0",
                        d = e && [],
                        u = [],
                    ...
                    for (o && (x = t === k || t || o); c !== g && null != (r = p[c]); c++) {
                        if (b && r) {
                            for (s = 0, t || r.ownerDocument === k || (_(r), i = !T); a = v[s++];)
                                if (a(r, t || k, i)) {
                                    n.push(r);
                                    break
                                } o && (E = h)
                    ...
                    if (l += c, y && c !== l) {
                        ...
                        L.apply(n, u), o && !e && 0 < u.length && 1 < l + m.length && re.uniqueSort(n)
                    }
                    return o && (E = h, x = f), d
                }, y ? ae(n) : n))).selector = e
            }
            ...
            if (i = i || [], 1 === d.length) {
                ...
                for (o = Y.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !w.relative[a = s.type]);)
                    if ((l = w.find[a]) && (n = l(s.matches[0].replace(J, ee), Z.test(r[0].type) && ge(t.parentNode) || t))) {
                        if (r.splice(o, 1), !(e = n.length && me(r))) return L.apply(i, n), i;
                        break
                    }
            }
            return (c || u(e, d))(n, t, !T, i, !t || Z.test(e) && ge(t.parentNode) || t), i
        }, p.sortStable = S.split("").sort(A).join("") === S, p.detectDuplicates = !!c, _(), p.sortDetached = le(function(e) {
    ...
    (S.fn.init = function(e, t, i) {
        var n, o;
        if (!e) return this;
        if (i = i || D, "string" != typeof e) return e.nodeType ? (this[0] = e, this.length = 1, this) : y(e) ? void 0 !== i.ready ? i.ready(e) : e(S) : S.makeArray(e, this);
        if (!(n = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : N.exec(e)) || !n[1] && t) return !t || t.jquery ? (t || i).find(e) : this.constructor(t).find(e);
        if (n[1]) {
            if (t = t instanceof S ? t[0] : t, S.merge(this, S.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : T, !0)), A.test(n[1]) && S.isPlainObject(t))
    ...
    S.fn.extend({
        ...
        S.fn[n] = function(e, t) {
            ...
            return "Until" !== n.slice(-5) && (t = e), t && "string" == typeof t && (i = S.filter(t, i)), 1 < this.length && (I[n] || S.uniqueSort(i), L.test(n) && i.reverse()), this.pushStack(i)
        }
    });
    var $ = /[^\x20\t\r\n\f]+/g;
    ...
    S.Callbacks = function(n) {
        var e, i;
        n = "string" == typeof n ? (e = n, i = {}, S.each(e.match($) || [], function(e, t) {
            i[t] = !0
        }), i) : S.extend({}, n);
        var o, t, r, s, a = [],
            l = [],
            c = -1,
            d = function() {
                for (s = s || n.once, r = o = !0; l.length; c = -1)
                ...
                s = {
                    ...
                    then: function(t, i, n) {
                                ...
                                var i = this,
                                    ...
                                    e = function() {
                                        ...
                                        if (!(o < l)) {
                                            ...
                                            t = e && ("object" == typeof e || "function" == typeof e) && e.then, y(t) ? a ? t.call(e, c(l, r, M, a), c(l, r, P, a)) : (l++, t.call(e, c(l, r, M, a), c(l, r, P, a), c(l, r, M, r.notifyWith))) : (s !== M && (i = void 0, n = [e]), (a || r.resolveWith)(i, n))
                                        }
                                    },
                                    t = a ? e : function() {
                                        try {
                                            ...
                                            S.Deferred.exceptionHook && S.Deferred.exceptionHook(e, t.stackTrace), l <= o + 1 && (s !== P && (i = void 0, n = [e]), r.rejectWith(i, n))
                                        }
                                    };
                        ...
                        return S.Deferred(function(e) {
                            r[0][3].add(c(0, e, y(n) ? n : M, e.notifyWith)), r[1][3].add(c(0, e, y(t) ? t : M)), r[2][3].add(c(0, e, y(i) ? i : P))
                        }).promise()
                    },
                    promise: function(e) {
        ...
        when: function(e) {
            ...
            if (i <= 1 && (H(e, r.done(s(t)).resolve, r.reject, !i), "pending" === r.state() || y(o[t] && o[t].then))) return r.then();
    ...
    var F = function(e, t, i, n, o, r, s) {
            ...
            else if (void 0 !== n && (o = !0, y(n) || (s = !0), c && (t = s ? (t.call(e, n), null) : (c = t, function(e, t, i) {
                    return c.call(S(e), i)
                })), t))
    ...
    S.extend({
        ...
        data: function(i, e) {
            ...
            if (void 0 !== i) return "object" == typeof i ? this.each(function() {
                ...
                var t;
                if (r && void 0 === e) {
                    if (void 0 !== (t = K.get(r, i))) return t;
                    if (void 0 !== (t = J(r, i))) return t
                } else this.each(function() {
                    K.set(this, i, e)
                })
            }, null, e, 1 < arguments.length, null, !0);
            if (this.length && (o = K.get(r), 1 === r.nodeType && !Q.get(r, "hasDataAttrs"))) {
                for (t = s.length; t--;) s[t] && 0 === (n = s[t].name).indexOf("data-") && (n = V(n.slice(5)), J(r, n, o[n]));
    ...
    function fe(e, t) {
        var i;
        return i = void 0 !== e.getElementsByTagName ? e.getElementsByTagName(t || "*") : void 0 !== e.querySelectorAll ? e.querySelectorAll(t || "*") : [], void 0 === t || t && C(e, t) ? S.merge([e], i) : i
    }
    ...
    function me(e, t, i, n, o) {
        for (var r, s, a, l, c, d, u = t.createDocumentFragment(), f = [], p = 0, h = e.length; p < h; p++)
            if ((r = e[p]) || 0 === r)
                if ("object" === x(r)) S.merge(f, r.nodeType ? [r] : r);
                else if (ve.test(r)) {
            for (s = s || u.appendChild(t.createElement("div")), a = (ce.exec(r) || ["", ""])[1].toLowerCase(), l = ue[a] || ue._default, s.innerHTML = l[1] + S.htmlPrefilter(r) + l[2], d = l[0]; d--;) s = s.lastChild;
            S.merge(f, s.childNodes), (s = u.firstChild).textContent = ""
        } else f.push(t.createTextNode(r));
        for (u.textContent = "", p = 0; r = f[p++];)
            if (n && -1 < S.inArray(r, n)) o && o.push(r);
            else if (c = S.contains(r.ownerDocument, r), s = fe(u.appendChild(r), "script"), c && pe(s), i)
            for (d = 0; r = s[d++];) de.test(r.type || "") && i.push(r);
        return u
    }
    ...
    S.event = {
        ...
        add: function(t, e, i, n, o) {
            ...
            if (v)
                for (i.handler && (i = (r = i).handler, o = r.selector), o && S.find.matchesSelector(ye, o), i.guid || (i.guid = S.guid++), (l = v.events) || (l = v.events = {}), (s = v.handle) || (s = v.handle = function(e) {
                        return void 0 !== S && S.event.triggered !== e.type ? S.event.dispatch.apply(t, arguments) : void 0
                    }), c = (e = (e || "").match($) || [""]).length; c--;) p = g = (a = xe.exec(e[c]) || [])[1], h = (a[2] || "").split(".").sort(), p && (u = S.event.special[p] || {}, p = (o ? u.delegateType : u.bindType) || p, u = S.event.special[p] || {}, d = S.extend({
                    type: p,
                    origType: g,
                    data: n,
                    handler: i,
                    ...
                    namespace: h.join(".")
                }, r), (f = l[p]) || ((f = l[p] = []).delegateCount = 0, u.setup && !1 !== u.setup.call(t, n, h, s) || t.addEventListener && t.addEventListener(p, s)), u.add && (u.add.call(t, d), d.handler.guid || (d.handler.guid = i.guid)), o ? f.splice(f.delegateCount++, 0, d) : f.push(d), S.event.global[p] = !0)
        },
            ...
            if (v && (l = v.events)) {
                for (c = (t = (t || "").match($) || [""]).length; c--;)
                    if (p = g = (a = xe.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), p) {
                        for (u = S.event.special[p] || {}, f = l[p = (n ? u.delegateType : u.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = f.length; r--;) d = f[r], !o && g !== d.origType || i && i.guid !== d.guid || a && !a.test(d.namespace) || n && n !== d.selector && ("**" !== n || !d.selector) || (f.splice(r, 1), d.selector && f.delegateCount--, u.remove && u.remove.call(e, d));
                        s && !f.length && (u.teardown && !1 !== u.teardown.call(e, h, v.handle) || S.removeEvent(e, p, v.handle), delete l[p])
                    } else
    ...
    function Ie(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            K.hasData(e) && (a = K.access(e), l = S.extend({}, a), K.set(t, l))
        }
    }
    ...
    function je(i, n, o, r) {
        ...
        var e, t, s, a, l, c, d = 0,
            ...
            p = n[0],
            h = y(p);
        if (h || 1 < u && "string" == typeof p && !m.checkClone && Ae.test(p)) return i.each(function(e) {
            var t = i.eq(e);
            h && (n[0] = p.call(this, e, t.html())), je(t, n, o, r)
        });
        if (u && (t = (e = me(n, i[0].ownerDocument, !1, i, r)).firstChild, 1 === e.childNodes.length && (e = t), t || r)) {
            for (a = (s = S.map(fe(e, "script"), Ne)).length; d < u; d++) l = e, d !== f && (l = S.clone(l, !0, !0), a && S.merge(s, fe(l, "script"))), o.call(i[d], l, d);
            if (a)
                for (c = s[s.length - 1].ownerDocument, S.map(s, Le), d = 0; d < a; d++) l = s[d], de.test(l.type || "") && !Q.access(l, "globalEval") && S.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? S._evalUrl && S._evalUrl(l.src) : w(l.textContent.replace(Oe, ""), c, l))
        }
        return i
    }

    function $e(e, t, i) {
        for (var n, o = t ? S.filter(t, e) : e, r = 0; null != (n = o[r]); r++) i || 1 !== n.nodeType || S.cleanData(fe(n)), n.parentNode && (i && S.contains(n.ownerDocument, n) && pe(fe(n, "script")), n.parentNode.removeChild(n));
        return e
    }
    S.extend({
        ...
        clone: function(e, t, i) {
            ...
            if (!(m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || S.isXMLDoc(e)))
                for (s = fe(d), n = 0, o = (r = fe(e)).length; n < o; n++) a = r[n], l = s[n], void 0, "input" === (c = l.nodeName.toLowerCase()) && le.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (t)
                if (i)
                    for (r = r || fe(e), s = s || fe(d), n = 0, o = r.length; n < o; n++) Ie(r[n], s[n]);
                else Ie(e, d);
            return 0 < (s = fe(d, "script")).length && pe(s, !u && fe(e, "script")), d
        },
    ...
    function qe(e, t, i) {
        ...
        return (i = i || Pe(e)) && ("" !== (s = i.getPropertyValue(t) || i[t]) || S.contains(e.ownerDocument, e) || (s = S.style(e, t)), !m.pixelBoxStyles() && Me.test(s) && He.test(t) && (n = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = i.width, a.width = n, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    function We(e, t) {
        ...
        function e() {
            if (l) {
                ...
                i = "1%" !== e.top, s = 12 === t(e.marginLeft), l.style.right = "60%", r = 36 === t(e.right), n = 36 === t(e.width), l.style.position = "absolute", o = 36 === l.offsetWidth || "absolute", ye.removeChild(a), l = null
            }
        }
    ...
    function Qe(e, t, i, n, o, r) {
        ...
        for (; s < 4; s += 2) "margin" === i && (l += S.css(e, i + ie[s], !0, o)), n ? ("content" === i && (l -= S.css(e, "padding" + ie[s], !0, o)), "margin" !== i && (l -= S.css(e, "border" + ie[s] + "Width", !0, o))) : (l += S.css(e, "padding" + ie[s], !0, o), "padding" !== i ? l += S.css(e, "border" + ie[s] + "Width", !0, o) : a += S.css(e, "border" + ie[s] + "Width", !0, o));
        return !n && 0 <= r && (l += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - r - l - a - .5))), l
    }
    ...
    function Ke(e, t, i) {
        ...
        return s = s && (m.boxSizingReliable() || o === e.style[t]), ("auto" === o || !parseFloat(o) && "inline" === S.css(e, "display", !1, n)) && (o = e["offset" + t[0].toUpperCase() + t.slice(1)], s = !0), (o = parseFloat(o) || 0) + Qe(e, t, i || (r ? "border" : "content"), s, n, o) + "px"
    }
    ...
    S.extend({
        ...
        style: function(e, t, i, n) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, s, a = V(t),
                    l = Fe.test(t),
                    c = e.style;
                if (l || (t = Ye(a)), s = S.cssHooks[t] || S.cssHooks[a], void 0 === i) return s && "get" in s && void 0 !== (o = s.get(e, !1, n)) ? o : c[t];
                "string" == (r = typeof i) && (o = te.exec(i)) && o[1] && (i = re(e, t, o), r = "number"), null != i && i == i && ("number" === r && (i += o && o[3] || (S.cssNumber[a] ? "" : "px")), m.clearCloneStyle || "" !== i || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (i = s.set(e, i, n)) || (l ? c.setProperty(t, i) : c[t] = i))
            }
        },
        css: function(e, t, i, n) {
            var o, r, s, a = V(t);
            return Fe.test(t) || (t = Ye(a)), (s = S.cssHooks[t] || S.cssHooks[a]) && "get" in s && (o = s.get(e, !0, i)), void 0 === o && (o = qe(e, t, n)), "normal" === o && t in Be && (o = Be[t]), "" === i || i ? (r = parseFloat(o), !0 === i || isFinite(r) ? r || 0 : o) : o
        }
    }), S.each(["height", "width"], function(e, a) {
        S.cssHooks[a] = {
            get: function(e, t, i) {
                if (t) return !Re.test(S.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ke(e, a, i) : oe(e, ze, function() {
                    return Ke(e, a, i)
                })
            },
            set: function(e, t, i) {
                var n, o = Pe(e),
                    ...
                    s = i && Qe(e, a, i, r, o);
                return r && m.scrollboxSize() === o.position && (s -= Math.ceil(e["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(o[a]) - Qe(e, a, "border", !1, o) - .5)), s && (n = te.exec(t)) && "px" !== (n[3] || "px") && (e.style[a] = t, t = S.css(e, a)), Xe(0, t, s)
            }
        }
        ...
        css: function(e, t) {
            return F(this, function(e, t, i) {
                var n, o, r = {},
                    s = 0;
                if (Array.isArray(t)) {
                    for (n = Pe(e), o = t.length; s < o; s++) r[t[s]] = S.css(e, t[s], !1, n);
                    return r
                }
        ...
        run: function(e) {
            ...
            return this.options.duration ? this.pos = t = S.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), i && i.set ? i.set(this) : Ge.propHooks._default.set(this), this
        }
    ...
    function ot() {
        Je && (!1 === T.hidden && k.requestAnimationFrame ? k.requestAnimationFrame(ot) : k.setTimeout(ot, S.fx.interval), S.fx.tick())
    }
    ...
    function lt(r, e, t) {
        var i, s, n = 0,
            ...
            l = function() {
                if (s) return !1;
                for (var e = Ze || rt(), t = Math.max(0, c.startTime + c.duration - e), i = 1 - (t / c.duration || 0), n = 0, o = c.tweens.length; n < o; n++) c.tweens[n].run(i);
        ...
        for (function(e, t) {
                var i, n, o, r, s;
                for (i in e)
                    if (o = t[n = V(i)], r = e[i], Array.isArray(r) && (o = r[1], r = e[i] = r[0]), i !== n && (e[n] = r, delete e[i]), (s = S.cssHooks[n]) && "expand" in s)
                        for (i in r = s.expand(r), delete e[n], r) i in e || (e[i] = r[i], t[i] = o);
                    else t[n] = o
            }(d, c.opts.specialEasing); n < o; n++)
            if (i = lt.prefilters[n].call(c, r, d, c.opts)) return y(i.stop) && (S._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return S.map(d, at, c), y(c.opts.start) && c.opts.start.call(r, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), S.fx.timer(S.extend(l, {
            elem: r,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    S.Animation = S.extend(lt, {
        ...
        tweener: function(e, t) {
            for (var i, n = 0, o = (e = y(e) ? (t = e, ["*"]) : e.match($)).length; n < o; n++) i = e[n], lt.tweeners[i] = lt.tweeners[i] || [], lt.tweeners[i].unshift(t)
        },
        prefilters: [function(e, t, i) {
            ...
            for (n in i.queue || (null == (s = S._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function() {
                ...
                for (n in u && 1 === e.nodeType && (i.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = v && v.display) && (c = Q.get(e, "display")), "none" === (d = S.css(e, "display")) && (c ? d = c : (ae([e], !0), c = e.style.display || c, d = S.css(e, "display"), ae([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === S.css(e, "float") && (l || (f.done(function() {
                        h.display = c
                    }), null == c && (d = h.display, c = "none" === d ? "" : d)), h.display = "inline-block")), i.overflow && (h.overflow = "hidden", f.always(function() {
                        h.overflow = i.overflow[0], h.overflowX = i.overflow[1], h.overflowY = i.overflow[2]
                    })), l = !1, p) l || (v ? "hidden" in v && (g = v.hidden) : v = Q.access(e, "fxshow", {
                    display: c
                }), r && (v.hidden = !g), g && ae([e], !0), f.done(function() {
                    for (n in g || ae([e]), Q.remove(e, "fxshow"), p) S.style(e, n, p[n])
                })), l = at(g ? v[n] : 0, n, f), n in v || (v[n] = l.start, g && (l.end = l.start, l.start = 0))
        }],
    ...
    S.fn.extend({
        ...
        dt[t] = function(e, t, i) {
            ...
            return i || (o = dt[r], dt[r] = n, n = null != s(e, t, i) ? r : null, dt[r] = o), n
        }
    });
    ...
    S.fn.extend({
        ...
        toggleClass: function(o, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(o) : this.removeClass(o) : y(o) ? this.each(function(e) {
                ...
                var e, t, i, n;
                if (s)
                    for (t = 0, i = S(this), n = gt(o); e = n[t++];) i.hasClass(e) ? i.removeClass(e) : i.addClass(e);
                else void 0 !== o && "boolean" !== r || ((e = ht(this)) && Q.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === o ? "" : Q.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, i, n = 0;
    ...
    S.extend(S.event, {
        trigger: function(e, t, i, n) {
            ...
            if (r = u = s = i = i || T, 3 !== i.nodeType && 8 !== i.nodeType && !mt.test(p + S.event.triggered) && (-1 < p.indexOf(".") && (p = (h = p.split(".")).shift(), h.sort()), l = p.indexOf(":") < 0 && "on" + p, (e = e[S.expando] ? e : new S.Event(p, "object" == typeof e && e)).isTrigger = n ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), t = null == t ? [e] : S.makeArray(t, [e]), d = S.event.special[p] || {}, n || !d.trigger || !1 !== d.trigger.apply(i, t))) {
                if (!n && !d.noBubble && !b(i)) {
                    for (a = d.delegateType || p, mt.test(a + p) || (r = r.parentNode); r; r = r.parentNode) f.push(r), s = r;
                    s === (i.ownerDocument || T) && f.push(s.defaultView || s.parentWindow || k)
                }
                for (o = 0;
                    (r = f[o++]) && !e.isPropagationStopped();) u = r, e.type = 1 < o ? a : d.bindType || p, (c = (Q.get(r, "events") || {})[e.type] && Q.get(r, "handle")) && c.apply(r, t), (c = l && r[l]) && c.apply && Y(r) && (e.result = c.apply(r, t), !1 === e.result && e.preventDefault());
                return e.type = p, n || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(f.pop(), t) || !Y(i) || l && y(i[p]) && !b(i) && ((s = i[l]) && (i[l] = null), S.event.triggered = p, e.isPropagationStopped() && u.addEventListener(p, yt), i[p](), e.isPropagationStopped() && u.removeEventListener(p, yt), S.event.triggered = void 0, s && (i[l] = s)), e.result
            }
        },
    ...
    Mt.href = bt.href, S.extend({
        ...
        ajax: function(e, t) {
            ...
            if (b.promise(_), v.url = ((e || v.url || bt.href) + "").replace(Lt, bt.protocol + "//"), v.type = t.method || t.type || v.method || v.type, v.dataTypes = (v.dataType || "*").toLowerCase().match($) || [""], null == v.crossDomain) {
                n = T.createElement("a");
                try {
            ...
            function c(e, t, i, n) {
                var o, r, s, a, l, c = t;
                h || (h = !0, p && k.clearTimeout(p), d = void 0, f = n || "", _.readyState = 0 < e ? 4 : 0, o = 200 <= e && e < 300 || 304 === e, i && (a = function(e, t, i) {
                ...
                }(v, a, _, o), o ? (v.ifModified && ((l = _.getResponseHeader("Last-Modified")) && (S.lastModified[u] = l), (l = _.getResponseHeader("etag")) && (S.etag[u] = l)), 204 === e || "HEAD" === v.type ? c = "nocontent" : 304 === e ? c = "notmodified" : (c = a.state, r = a.data, o = !(s = a.error))) : (s = c, !e && c || (c = "error", e < 0 && (e = 0))), _.status = e, _.statusText = (t || c) + "", o ? b.resolveWith(m, [r, c, _]) : b.rejectWith(m, [_, c, s]), _.statusCode(x), x = void 0, g && y.trigger(o ? "ajaxSuccess" : "ajaxError", [_, v, o ? r : s]), w.fireWith(m, [_, c]), g && (y.trigger("ajaxComplete", [_, v]), --S.active || S.event.trigger("ajaxStop")))
            }
            return _
        },
    ...
    m.cors = !!Rt && "withCredentials" in Rt, m.ajax = Rt = !!Rt, S.ajaxTransport(function(o) {
        var r, s;
        if (m.cors || Rt && !o.crossDomain) return {
            send: function(e, t) {
                ...
                r = function(e) {
                    return function() {
                        r && (r = s = n.onload = n.onerror = n.onabort = n.ontimeout = n.onreadystatechange = null, "abort" === e ? n.abort() : "error" === e ? "number" != typeof n.status ? t(0, "error") : t(n.status, n.statusText) : t(Wt[n.status] || n.status, n.statusText, "text" !== (n.responseType || "text") || "string" != typeof n.responseText ? {
                            binary: n.response
                        } : {
                            text: n.responseText
    ...
    S.ajaxSetup({
        ...
        if (s || "jsonp" === e.dataTypes[0]) return n = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Bt, "$1" + n) : !1 !== e.jsonp && (e.url += (xt.test(e.url) ? "&" : "?") + e.jsonp + "=" + n), e.converters["script json"] = function() {
            return r || S.error(n + " was not called"), r[0]
        }, e.dataTypes[0] = "json", o = k[n], k[n] = function() {
            r = arguments
        }, i.always(function() {
            void 0 === o ? S(k).removeProp(n) : k[n] = o, e[n] && (e.jsonpCallback = t.jsonpCallback, zt.push(n)), r && y(o) && o(r[0]), r = o = void 0
        }), "script"
    }), m.createHTMLDocument = ((Ft = T.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Ft.childNodes.length), S.parseHTML = function(e, t, i) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (i = t, t = !1), t || (m.createHTMLDocument ? ((n = (t = T.implementation.createHTMLDocument("")).createElement("base")).href = T.location.href, t.head.appendChild(n)) : t = T), r = !i && [], (o = A.exec(e)) ? [t.createElement(o[1])] : (o = me([e], t, r), r && r.length && S(r).remove(), S.merge([], o.childNodes)));
        var n, o, r
    }, S.fn.load = function(e, t, i) {
        var n, o, r, s = this,
            a = e.indexOf(" ");
        return -1 < a && (n = pt(e.slice(a)), e = e.slice(0, a)), y(t) ? (i = t, t = void 0) : t && "object" == typeof t && (o = "POST"), 0 < s.length && S.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        S.cssHooks[i] = We(m.pixelPosition, function(e, t) {
            if (t) return t = qe(e, i), Me.test(t) ? S(e).position()[i] + "px" : t
        })
    }), S.each({
        Height: "height",
        Width: "width"
        ...
        S.each({
            ...
            S.fn[r] = function(e, t) {
                ...
                return F(this, function(e, t, i) {
                    var n;
                    return b(e) ? 0 === r.indexOf("outer") ? e["inner" + s] : e.document.documentElement["client" + s] : 9 === e.nodeType ? (n = e.documentElement, Math.max(e.body["scroll" + s], n["scroll" + s], e.body["offset" + s], n["offset" + s], n["client" + s])) : void 0 === i ? S.css(e, t, o) : S.style(e, t, i, o)
                }, a, i ? e : void 0, i)
            }
        })
    ...
    }, S.isArray = Array.isArray, S.parseJSON = JSON.parse, S.nodeName = C, S.isFunction = y, S.isWindow = b, S.camelCase = V, S.type = x, S.now = Date.now, S.isNumeric = function(e) {
        var t = S.type(e);
    ...
    return S.noConflict = function(e) {
        return k.$ === S && (k.$ = Vt), e && k.jQuery === S && (k.jQuery = Ut), S
    }, e || (k.jQuery = k.$ = S), S
}),
function(e, t) {
    ...
    function y(e) {
        ...
        for (var t = g(10) ? document.body : null, i = e.offsetParent; i === t && e.nextElementSibling;) i = (e = e.nextElementSibling).offsetParent;
        var n = i && i.nodeName;
    ...
    function p(e, t) {
        ...
        if (e !== l && t !== l || n.contains(o)) return "BODY" === (a = (s = l).nodeName) || "HTML" !== a && y(s.firstElementChild) !== s ? y(l) : l;
        var c = d(e);
    ...
    function _(e, t) {
        ...
        i && "HTML" === t.nodeName && (s.top = P(s.top, 0), s.left = P(s.left, 0));
        var u = x({
            top: r.top - s.top - c,
        ...
        if (u.marginTop = 0, u.marginLeft = 0, !n && o) {
            ...
            u.top -= c - f, u.bottom -= c - f, u.left -= d - p, u.right -= d - p, u.marginTop = f, u.marginLeft = p
        }
        ...
        if ("viewport" === n) r = function(e) {
            ...
            if ("HTML" !== a.nodeName || function e(t) {
                ...
                var c = m(),
                    d = c.height,
                    u = c.width;
                r.top += l.top - l.marginTop, r.bottom = d + l.top, r.left += l.left - l.marginLeft, r.right = u + l.left
            }
        }
    ...
    function C(e, t, i) {
        ...
        var n = S(e),
            ...
            l = r ? "height" : "width",
            c = r ? "width" : "height";
        return o[s] = t[s] + t[l] / 2 - n[l] / 2, o[a] = i === a ? t[a] - n[c] : t[E(a)], o
    }
    ...
    function O(e, i, t) {
        return (void 0 === t ? e : e.slice(0, function(e, t, i) {
            ...
            e.enabled && s(t) && (i.offsets.popper = x(i.offsets.popper), i.offsets.reference = x(i.offsets.reference), i = t(i, e))
        }), i
    }
    ...
    function t(e, t, i, n) {
        i.updateBound = n, r(e).addEventListener("resize", i.updateBound, {
            passive: !0
        });
        var o = h(e);
        return function e(t, i, n, o) {
            ...
            s.addEventListener(i, n, {
                passive: !0
            }), r || e(h(s.parentNode), i, n, o), o.push(s)
    ...
    function c(i, n) {
        Object.keys(n).forEach(function(e) {
            var t = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && N(n[e]) && (t = "px"), i.style[e] = n[e] + t
        })
    }
            ...
            return e.reduce(function(e, t) {
                ...
                return function(e, t, i, n) {
                    var o, r = e.match(/((?:\-|\+)?\d*\.?\d*)(.*)/),
                        ...
                        a = r[2];
                    if (!s) return e;
                    if (0 !== a.indexOf("%")) return "vh" !== a && "vw" !== a ? s : ("vh" === a ? P(document.documentElement.clientHeight, window.innerHeight || 0) : P(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * s;
                    switch (a) {
                        case "%p":
                            o = i;
                            break;
    ...
    for (var j = Math.min, $ = Math.round, M = Math.floor, P = Math.max, H = "undefined" != typeof window && "undefined" != typeof document, q = ["Edge", "Trident", "Firefox"], W = 0, R = 0; R < q.length; R += 1)
        ...
        J = function() {
            function r(e, t) {
                ...
                }, this.update = F(this.update.bind(this)), this.options = Y({}, r.Defaults, n), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = e && e.jquery ? e[0] : e, this.popper = t && t.jquery ? t[0] : t, this.options.modifiers = {}, Object.keys(Y({}, r.Defaults.modifiers, n.modifiers)).forEach(function(e) {
                ...
                value: function() {
                    return function() {
                        if (!this.state.isDestroyed) {
                            ...
                            e.offsets.reference = l(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = a(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = C(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = O(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                        }
                    }.call(this)
                }
            }, {
        ...
        modifiers: {
            ...
            offset: {
                ...
                fn: function(e, t) {
                    var i, n = t.offset,
                        ...
                        a = r.reference,
                        l = o.split("-")[0];
                    return i = N(+n) ? [+n, 0] : I(n, s, a, l), "left" === l ? (s.top += i[0], s.left -= i[1]) : "right" === l ? (s.top += i[0], s.left += i[1]) : "top" === l ? (s.left += i[0], s.top -= i[1]) : "bottom" === l && (s.left += i[0], s.top += i[1]), e.popper = s, e
                },
                offset: 0
            },
            preventOverflow: {
                ...
                fn: function(e, n) {
                    ...
                    var c = n.priority,
                        ...
                        u = {
                            primary: function(e) {
                                var t = d[e];
                                return d[e] < l[e] && !n.escapeWithReference && (t = P(d[e], l[e])), V({}, e, t)
                            },
                            secondary: function(e) {
                                var t = "right" === e ? "left" : "top",
                                    i = d[t];
                                return d[e] > l[e] && !n.escapeWithReference && (i = j(d[t], l[e] - ("right" === e ? d.width : d.height))), V({}, t, i)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    var o = e.placement.split("-")[0],
                        ...
                        p = l ? "bottom" : "right",
                        h = S(n)[c];
                    a[p] - h < s[u] && (e.offsets.popper[u] -= s[u] - (a[p] - h)), a[u] + h > s[p] && (e.offsets.popper[u] += a[u] + h - s[p]), e.offsets.popper = x(e.offsets.popper);
                    var g = a[u] + a[c] / 2 - h / 2,
                        v = w(e.instance.popper),
                        m = parseFloat(v["margin" + d], 10),
                        y = parseFloat(v["border" + d + "Width"], 10),
                        b = g - e.offsets.popper[u] - m - y;
                    return b = P(j(s[c] - h, b), 0), e.arrowElement = n, e.offsets.arrow = (V(i = {}, u, $(b)), V(i, f, ""), i), e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(h, g) {
                    ...
                    return w.forEach(function(e, t) {
                        if (m !== e || w.length === t + 1) return h;
                        m = h.placement.split("-")[0], y = E(m);
                        ...
                        (s || u || p) && (h.flipped = !0, (s || u) && (m = w[t + 1]), p && (b = "end" === (i = b) ? "start" : "start" === i ? "end" : i), h.placement = m + (b ? "-" + b : ""), h.offsets.popper = Y({}, h.offsets.popper, C(h.instance.popper, h.offsets.reference, h.placement)), h = O(h.instance.modifiers, h, "flip"))
                    }), h
                },
                behavior: "flip",
                padding: 5,
            ...
            inner: {
                ...
                fn: function(e) {
                    ...
                    return o[s ? "left" : "top"] = r[i] - (a ? o[s ? "width" : "height"] : 0), e.placement = E(t), e.offsets.popper = x(o), e
                }
            },
            hide: {
                order: 800,
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, a, l = void 0 === r ? t.gpuAcceleration : r,
                        ...
                        h = D("transform");
                    if (a = "bottom" == f ? -c.height + u.bottom : u.top, s = "right" == p ? -c.width + u.right : u.left, l && h) d[h] = "translate3d(" + s + "px, " + a + "px, 0)", d[f] = 0, d[p] = 0, d.willChange = "transform";
                    else {
                        var g = "bottom" == f ? -1 : 1,
                            v = "right" == p ? -1 : 1;
                        d[f] = a * g, d[p] = s * v, d.willChange = f + ", " + p
                    }
                    var m = {
                        "x-placement": e.placement
                    };
                    return e.attributes = Y({}, m, e.attributes), e.styles = Y({}, d, e.styles), e.arrowStyles = Y({}, e.offsets.arrow, e.arrowStyles), e
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
...
function(e, t) {
    ...
    var o, i, r, a, c, u, f, p, h, g, v, m, y, b, w, x, _, k, T, S, E, C, A, O, D, N, L, I, j, $, M, P, H, q, W, R, F, z, B, U, V, Y, X, Q, K, G, Z, J, ee, te, ie, ne, oe, re, se, ae, le, ce, de, ue, fe, pe, he, ge, ve, me, ye, be, we, xe, _e, ke, Te, Se, Ee, Ce, Ae, Oe, De, Ne, Le, Ie, je, $e, Me, Pe, He, qe, We, Re, Fe, ze, Be, Ue, Ve, Ye, Xe, Qe, Ke, Ge, Ze, Je, et, tt, it, nt, ot, rt, st, at, lt, ct, dt, ut, ft, pt, ht, gt, vt, mt, yt, bt, wt, xt, _t, kt, Tt, St, Et, Ct = (St = "transitionend", Et = {
        ...
        At = (i = "alert", a = "." + (r = "bs.alert"), c = (o = t).fn[i], u = {
            CLOSE: "close" + a,
            CLOSED: "closed" + a,
            ...
            return e.close = function(e) {
                ...
                var t = Ct.getSelectorFromElement(e),
                    i = !1;
                return t && (i = document.querySelector(t)), i || (i = o(e).closest(".alert")[0]), i
                ...
                return this.each(function() {
                    var e = o(this),
                        t = e.data(r);
                    t || (t = new n(this), e.data(r, t)), "close" === i && t[i](this)
                })
        ...
        }(), o(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', f._handleDismiss(new f)), o.fn[i] = f._jQueryInterface, o.fn[i].Constructor = f, o.fn[i].noConflict = function() {
            return o.fn[i] = c, f._jQueryInterface
        }, f),
        Ot = (h = "button", v = "." + (g = "bs.button"), m = ".data-api", y = (p = t).fn[h], b = "active", "btn", w = '[data-toggle^="button"]', '[data-toggle="buttons"]', "input", ".active", ".btn", x = {
            ...
            return e.toggle = function() {
                ...
                if (i) {
                    ...
                    if (n) {
                        if ("radio" === n.type)
                            ...
                            n.checked = !this._element.classList.contains(b), p(n).trigger("change")
                        }
                        n.focus(), t = !1
                    }
                }
                ...
                return this.each(function() {
                    var e = p(this).data(g);
                    e || (e = new i(this), p(this).data(g, e)), "toggle" === t && e[t]()
                })
            }, s(i, null, [{
                key: "VERSION",
                get: function() {
        ...
        }), p.fn[h] = _._jQueryInterface, p.fn[h].Constructor = _, p.fn[h].noConflict = function() {
            return p.fn[h] = y, _._jQueryInterface
        }, _),
        Dt = (T = "carousel", E = "." + (S = "bs.carousel"), C = ".data-api", A = (k = t).fn[T], O = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
        ...
        }, "carousel", j = "active", "slide", "carousel-item-right", "carousel-item-left", "carousel-item-next", "carousel-item-prev", ".active", $ = ".active.carousel-item", ".carousel-item", ".carousel-item-next, .carousel-item-prev", ".carousel-indicators", "[data-slide], [data-slide-to]", '[data-ride="carousel"]', M = function() {
            function r(e, t) {
                this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(t), this._element = k(e)[0], this._indicatorsElement = this._element.querySelector(".carousel-indicators"), this._addEventListeners()
            }
            var e = r.prototype;
            return e.next = function() {
                ...
                if (!(e > this._items.length - 1 || e < 0))
                    if (this._isSliding) k(this._element).one(I.SLID, function() {
                        return t.to(e)
                    });
                    else {
                ...
                k(this._element).off(E), k.removeData(this._element, S), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, e._getConfig = function(e) {
                return e = l({}, O, e), Ct.typeCheckConfig(T, e, D), e
                ...
                if (o = e === N ? (i = "carousel-item-left", n = "carousel-item-next", "left") : (i = "carousel-item-right", n = "carousel-item-prev", "right"), l && k(l).hasClass(j)) this._isSliding = !1;
                    ...
                    if (k(this._element).hasClass("slide")) {
                        k(l).addClass(n), Ct.reflow(l), k(s).addClass(i), k(l).addClass(i);
                        var f = Ct.getTransitionDurationFromElement(s);
                        k(s).one(Ct.TRANSITION_END, function() {
                            k(l).removeClass(i + " " + n).addClass(j), k(s).removeClass(j + " " + n + " " + i), r._isSliding = !1, setTimeout(function() {
                                return k(r._element).trigger(u)
                            }, 0)
                        }).emulateTransitionEnd(f)
                    } else k(s).removeClass(j), k(l).addClass(j), this._isSliding = !1, k(this._element).trigger(u);
                    d && this.cycle()
                }
                ...
                return this.each(function() {
                    ...
                    if (e || (e = new r(this, t), k(this).data(S, e)), "number" == typeof n) e.to(n);
                ...
                if (t) {
                    ...
                    if (i && k(i).hasClass("carousel")) {
                        ...
                        o && (n.interval = !1), r._jQueryInterface.call(k(i), n), o && k(i).data(S).to(o), e.preventDefault()
                    }
                }
            }, s(r, null, [{
                key: "VERSION",
        ...
        }(), k(document).on(I.CLICK_DATA_API, "[data-slide], [data-slide-to]", M._dataApiClickHandler), k(window).on(I.LOAD_DATA_API, function() {
            for (var e = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), t = 0, i = e.length; t < i; t++) {
                var n = k(e[t]);
                M._jQueryInterface.call(n, n.data())
            }
        }), k.fn[T] = M._jQueryInterface, k.fn[T].Constructor = M, k.fn[T].noConflict = function() {
            return k.fn[T] = A, M._jQueryInterface
        }, M),
        Nt = (H = "collapse", W = "." + (q = "bs.collapse"), R = (P = t).fn[H], F = {
            toggle: !0,
            parent: ""
        }, z = {
            toggle: "boolean",
        ...
        }, U = "show", V = "collapse", Y = "collapsing", X = "collapsed", "width", "height", ".show, .collapsing", Q = '[data-toggle="collapse"]', K = function() {
            function a(t, e) {
            ...
            return e.toggle = function() {
                ...
                if (!(this._isTransitioning || P(this._element).hasClass(U) || (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(e) {
                    ...
                    if (P(this._element).trigger(n), !n.isDefaultPrevented()) {
                        ...
                        P(this._element).removeClass(V).addClass(Y), this._element.style[o] = 0, this._triggerArray.length && P(this._triggerArray).removeClass(X).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var r = "scroll" + (o[0].toUpperCase() + o.slice(1)),
                            s = Ct.getTransitionDurationFromElement(this._element);
                        P(this._element).one(Ct.TRANSITION_END, function() {
                            P(i._element).removeClass(Y).addClass(V).addClass(U), i._element.style[o] = "", i.setTransitioning(!1), P(i._element).trigger(B.SHOWN)
                ...
                if (!this._isTransitioning && P(this._element).hasClass(U)) {
                    ...
                    if (P(this._element).trigger(t), !t.isDefaultPrevented()) {
                        ...
                        this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", Ct.reflow(this._element), P(this._element).addClass(Y).removeClass(V).removeClass(U);
                        ...
                        P(this._element).one(Ct.TRANSITION_END, function() {
                            e.setTransitioning(!1), P(e._element).removeClass(Y).addClass(V).trigger(B.HIDDEN)
                ...
                return (e = l({}, F, e)).toggle = Boolean(e.toggle), Ct.typeCheckConfig(H, e, z), e
                ...
                return this.each(function() {
                    ...
                    if (!t && i.toggle && /show|hide/.test(n) && (i.toggle = !1), t || (t = new a(this, i), e.data(q, t)), "string" == typeof n) {
            ...
            return P.fn[H] = R, K._jQueryInterface
        }, K),
        Lt = (Z = "dropdown", ee = "." + (J = "bs.dropdown"), te = ".data-api", ie = (G = t).fn[Z], ne = new RegExp("38|40|27"), oe = {
            HIDE: "hide" + ee,
            HIDDEN: "hidden" + ee,
            SHOW: "show" + ee,
            SHOWN: "shown" + ee,
        ...
        }, re = "disabled", se = "show", "dropup", "dropright", "dropleft", ae = "dropdown-menu-right", "position-static", le = '[data-toggle="dropdown"]', ".dropdown form", ce = ".dropdown-menu", ".navbar-nav", ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", "top-start", "top-end", "bottom-start", "bottom-end", "right-start", "left-start", de = {
            offset: 0,
            flip: !0,
            ...
            return e.toggle = function() {
                    ...
                    if (c._clearMenus(), !t) {
                        ...
                        if (G(e).trigger(n), !n.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var o = this._element;
                                "parent" === this._config.reference ? o = e : Ct.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && G(e).addClass("position-static"), this._popper = new d(o, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === G(e).closest(".navbar-nav").length && G(document.body).children().on("mouseover", null, G.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), G(this._menu).toggleClass(se), G(e).toggleClass(se).trigger(G.Event(oe.SHOWN, i))
                        }
                    }
                }
            }, e.dispose = function() {
                G.removeData(this._element, J), G(this._element).off(ee), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
            }, e.update = function() {
                ...
                return e = l({}, this.constructor.Default, G(this._element).data(), e), Ct.typeCheckConfig(Z, e, this.constructor.DefaultType), e
                ...
                var e = G(this._element.parentNode),
                    t = "bottom-start";
                return e.hasClass("dropup") ? (t = "top-start", G(this._menu).hasClass(ae) && (t = "top-end")) : e.hasClass("dropright") ? t = "right-start" : e.hasClass("dropleft") ? t = "left-start" : G(this._menu).hasClass(ae) && (t = "bottom-end"), t
                ...
                return this.each(function() {
                    var e = G(this).data(J);
                    if (e || (e = new c(this, "object" == typeof t ? t : null), G(this).data(J, e)), "string" == typeof t) {
                    ...
                    for (var t = [].slice.call(document.querySelectorAll(le)), i = 0, n = t.length; i < n; i++) {
                        ...
                        if (e && "click" === e.type && (s.clickEvent = e), r) {
                            ...
                            if (G(o).hasClass(se) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && G.contains(o, e.target))) {
                                ...
                                G(o).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && G(document.body).children().off("mouseover", null, G.noop), t[i].setAttribute("aria-expanded", "false"), G(a).removeClass(se), G(o).removeClass(se).trigger(G.Event(oe.HIDDEN, s)))
                            }
                        }
                    }
                ...
                if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || G(e.target).closest(ce).length)) : ne.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !G(this).hasClass(re))) {
            ...
            e.preventDefault(), e.stopPropagation(), fe._jQueryInterface.call(G(this), "toggle")
        }).on(oe.CLICK_DATA_API, ".dropdown form", function(e) {
            e.stopPropagation()
        }), G.fn[Z] = fe._jQueryInterface, G.fn[Z].Constructor = fe, G.fn[Z].noConflict = function() {
            return G.fn[Z] = ie, fe._jQueryInterface
        }, fe),
        It = (he = "modal", ve = "." + (ge = "bs.modal"), me = (pe = t).fn[he], ye = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
        ...
        }, "modal-scrollbar-measure", "modal-backdrop", xe = "modal-open", _e = "fade", ke = "show", ".modal-dialog", '[data-toggle="modal"]', '[data-dismiss="modal"]', Te = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", Se = ".sticky-top", Ee = function() {
            function o(e, t) {
            ...
            return e.toggle = function(e) {
                ...
                if (!this._isTransitioning && !this._isShown) {
                    ...
                    pe(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), pe(document.body).addClass(xe), this._setEscapeEvent(), this._setResizeEvent(), pe(this._element).on(we.CLICK_DISMISS, '[data-dismiss="modal"]', function(e) {
                        return t.hide(e)
                ...
                if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                    ...
                    if (pe(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                        this._isShown = !1;
                        var n = pe(this._element).hasClass(_e);
                        if (n && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), pe(document).off(we.FOCUSIN), pe(this._element).removeClass(ke), pe(this._element).off(we.CLICK_DISMISS), pe(this._dialog).off(we.MOUSEDOWN_DISMISS), n) {
                ...
                return e = l({}, ye, e), Ct.typeCheckConfig(he, e, be), e
                ...
                var n = pe.Event(we.SHOWN, {
                    ...
                    o = function() {
                        t._config.focus && t._element.focus(), t._isTransitioning = !1, pe(t._element).trigger(n)
                    };
                if (i) {
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), pe(this._backdrop).appendTo(document.body), pe(this._element).on(we.CLICK_DISMISS, function(e) {
                            t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._element.focus() : t.hide())
                        }), i && Ct.reflow(this._backdrop), pe(this._backdrop).addClass(ke), !e) return;
                    if (!i) return void e();
                ...
                pe(e).each(function(e, t) {
                    ...
                    pe(t).removeData("padding-right"), t.style.paddingRight = i || ""
                });
                ...
                pe(document.body).removeData("padding-right"), document.body.style.paddingRight = i || ""
                ...
                return this.each(function() {
                    ...
                    if (e || (e = new o(this, t), pe(this).data(ge, e)), "string" == typeof i) {
                        if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                        e[i](n)
        ...
        }), pe.fn[he] = Ee._jQueryInterface, pe.fn[he].Constructor = Ee, pe.fn[he].noConflict = function() {
            return pe.fn[he] = me, Ee._jQueryInterface
        }, Ee),
        jt = (Ae = "tooltip", De = "." + (Oe = "bs.tooltip"), Ne = (Ce = t).fn[Ae], Le = "bs-tooltip", Ie = new RegExp("(^|\\s)" + Le + "\\S+", "g"), Me = {
            animation: !0,
        ...
        }, qe = "fade", We = "show", ".tooltip-inner", ".arrow", Re = "hover", Fe = "focus", "click", "manual", ze = function() {
            function n(e, t) {
            ...
            return e.enable = function() {
                ...
                if (this._isEnabled)
                    if (e) {
                        ...
                        i || (i = new this.constructor(e.currentTarget, this._getDelegateConfig()), Ce(e.currentTarget).data(t, i)), i._activeTrigger.click = !i._activeTrigger.click, i._isWithActiveTrigger() ? i._enter(null, i) : i._leave(null, i)
                    } else {
                        if (Ce(this.getTipElement()).hasClass(We)) return void this._leave(null, this);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    n.setAttribute("id", o), this.element.setAttribute("aria-describedby", o), this.setContent(), this.config.animation && Ce(n).addClass(qe);
                    ...
                    Ce(n).data(this.constructor.DATA_KEY, this), Ce.contains(this.element.ownerDocument.documentElement, this.tip) || Ce(n).appendTo(a), Ce(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new d(this.element, n, {
                        placement: s,
                        modifiers: {
                            offset: {
                    ...
                    }), Ce(n).addClass(We), "ontouchstart" in document.documentElement && Ce(document.body).children().on("mouseover", null, Ce.noop);
                    var l = function() {
                ...
                var t = this,
                    ...
                    o = function() {
                        t._hoverState !== Pe && i.parentNode && i.parentNode.removeChild(i), t._cleanTipClass(), t.element.removeAttribute("aria-describedby"), Ce(t.element).trigger(t.constructor.Event.HIDDEN), null !== t._popper && t._popper.destroy(), e && e()
                    };
                if (Ce(this.element).trigger(n), !n.isDefaultPrevented()) {
                    if (Ce(i).removeClass(We), "ontouchstart" in document.documentElement && Ce(document.body).children().off("mouseover", null, Ce.noop), this._activeTrigger.click = !1, this._activeTrigger[Fe] = !1, this._activeTrigger[Re] = !1, Ce(this.tip).hasClass(qe)) {
                ...
                this.setElementContent(Ce(e.querySelectorAll(".tooltip-inner")), this.getTitle()), Ce(e).removeClass(qe + " " + We)
                ...
                this.config.trigger.split(" ").forEach(function(e) {
                    if ("click" === e) Ce(n.element).on(n.constructor.Event.CLICK, n.config.selector, function(e) {
                        return n.toggle(e)
                    });
                    else if ("manual" !== e) {
                ...
                var i = this.constructor.DATA_KEY;
                (t = t || Ce(e.currentTarget).data(i)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), Ce(e.currentTarget).data(i, t)), e && (t._activeTrigger["focusout" === e.type ? Fe : Re] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = "out", t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function() {
                ...
                return "number" == typeof(e = l({}, this.constructor.Default, Ce(this.element).data(), "object" == typeof e && e ? e : {})).delay && (e.delay = {
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), Ct.typeCheckConfig(Ae, e, this.constructor.DefaultType), e
                ...
                null === e.getAttribute("x-placement") && (Ce(e).removeClass(qe), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
            }, n._jQueryInterface = function(i) {
                return this.each(function() {
                    var e = Ce(this).data(Oe),
                        t = "object" == typeof i && i;
                    if ((e || !/dispose|hide/.test(i)) && (e || (e = new n(this, t), Ce(this).data(Oe, e)), "string" == typeof i)) {
                        if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                        e[i]()
                    }
                })
        ...
        }(), Ce.fn[Ae] = ze._jQueryInterface, Ce.fn[Ae].Constructor = ze, Ce.fn[Ae].noConflict = function() {
            return Ce.fn[Ae] = Ne, ze._jQueryInterface
        }, ze),
        $t = (Ue = "popover", Ye = "." + (Ve = "bs.popover"), Xe = (Be = t).fn[Ue], Qe = "bs-popover", Ke = new RegExp("(^|\\s)" + Qe + "\\S+", "g"), Ge = l({}, jt.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            ...
            return o.isWithContent = function() {
                ...
                return this.each(function() {
                    ...
                    if ((e || !/destroy|hide/.test(i)) && (e || (e = new n(this, t), Be(this).data(Ve, e)), "string" == typeof i)) {
                        if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                        e[i]()
                    }
                })
        ...
        }(jt), Be.fn[Ue] = et._jQueryInterface, Be.fn[Ue].Constructor = et, Be.fn[Ue].noConflict = function() {
            return Be.fn[Ue] = Xe, et._jQueryInterface
        }, et),
        Mt = (it = "scrollspy", ot = "." + (nt = "bs.scrollspy"), rt = (tt = t).fn[it], st = {
            offset: 10,
            method: "auto",
            target: ""
        }, at = {
        ...
        }, "dropdown-item", ct = "active", '[data-spy="scroll"]', ".active", dt = ".nav, .list-group", ut = ".nav-link", ".nav-item", ft = ".list-group-item", ".dropdown", ".dropdown-item", ".dropdown-toggle", "offset", pt = "position", ht = function() {
            function i(e, t) {
                var i = this;
            ...
            return e.refresh = function() {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map(function(e) {
                    ...
                    if (i && (t = document.querySelector(i)), t) {
                        ...
                        if (n.width || n.height) return [tt(t)[o]().top + r, i]
                    }
                    return null
                }).filter(function(e) {
                    return e
                ...
                tt.removeData(this._element, nt), tt(this._scrollElement).off(ot), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, e._getConfig = function(e) {
                if ("string" != typeof(e = l({}, st, "object" == typeof e && e ? e : {})).target) {
                    var t = tt(e.target).attr("id");
                    t || (t = Ct.getUID(it), tt(e.target).attr("id", t)), e.target = "#" + t
                }
                return Ct.typeCheckConfig(it, e, at), e
                ...
                i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(ct), i.addClass(ct)) : (i.addClass(ct), i.parents(dt).prev(ut + ", " + ft).addClass(ct), i.parents(dt).prev(".nav-item").children(ut).addClass(ct)), tt(this._scrollElement).trigger(lt.ACTIVATE, {
                    relatedTarget: t
                })
            }, e._clear = function() {
                ...
                return this.each(function() {
                    ...
                    if (e || (e = new i(this, "object" == typeof t && t), tt(this).data(nt, e)), "string" == typeof t) {
                        if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
                        e[t]()
                    }
                })
        ...
        }), tt.fn[it] = ht._jQueryInterface, tt.fn[it].Constructor = ht, tt.fn[it].noConflict = function() {
            return tt.fn[it] = rt, ht._jQueryInterface
        }, ht),
        Pt = (mt = "." + (vt = "bs.tab"), yt = (gt = t).fn.tab, bt = {
            HIDE: "hide" + mt,
            HIDDEN: "hidden" + mt,
            SHOW: "show" + mt,
            SHOWN: "shown" + mt,
            CLICK_DATA_API: "click" + mt + ".data-api"
        }, "dropdown-menu", wt = "active", "disabled", "fade", "show", ".dropdown", ".nav, .list-group", xt = ".active", _t = "> li > .active", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', ".dropdown-toggle", "> .dropdown-menu .active", kt = function() {
            function n(e) {
                this._element = e
            }
            var e = n.prototype;
            return e.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && gt(this._element).hasClass(wt) || gt(this._element).hasClass("disabled"))) {
                    ...
                    if (n && gt(n).trigger(s), gt(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented()) {
                        ...
                        var l = function() {
                            ...
                            gt(n).trigger(e), gt(i._element).trigger(t)
                        };
                        e ? this._activate(e, e.parentNode, l) : l()
                    }
                }
            }, e.dispose = function() {
                gt.removeData(this._element, vt), this._element = null
                ...
                if (t) {
                    ...
                    n && gt(n).removeClass(wt), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
                }
                if (gt(e).addClass(wt), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), Ct.reflow(e), gt(e).addClass("show"), e.parentNode && gt(e.parentNode).hasClass("dropdown-menu")) {
                ...
                return this.each(function() {
                    var e = gt(this),
                        t = e.data(vt);
                    if (t || (t = new n(this), e.data(vt, t)), "string" == typeof i) {
            ...
            e.preventDefault(), kt._jQueryInterface.call(gt(this), "show")
        }), gt.fn.tab = kt._jQueryInterface, gt.fn.tab.Constructor = kt, gt.fn.tab.noConflict = function() {
            return gt.fn.tab = yt, kt._jQueryInterface
        }, kt);
    ! function(e) {
        if (void 0 === e) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
        var t = e.fn.jquery.split(" ")[0].split(".");
        if (t[0] < 2 && t[1] < 9 || 1 === t[0] && 9 === t[1] && t[2] < 1 || 4 <= t[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
    }(t), e.Util = Ct, e.Alert = At, e.Button = Ot, e.Carousel = Dt, e.Collapse = Nt, e.Dropdown = Lt, e.Modal = It, e.Popover = $t, e.Scrollspy = Mt, e.Tab = Pt, e.Tooltip = jt, Object.defineProperty(e, "__esModule", {
        value: !0
    })
        ...
        function h(e) {
            ...
            if (e.parents(".cd-headline").hasClass("type")) {
                ...
                }(e.find("i").eq(0), e, n, o), v(t.find("i").eq(0), t, n, o)
            } else e.parents(".cd-headline").hasClass("clip") ? e.parents(".cd-words-wrapper").animate({
                width: "2px"
            }, p, function() {
                y(e, t), g(t)
            }) : e.parents(".cd-headline").hasClass("loading-bar") ? (e.parents(".cd-words-wrapper").removeClass("is-loading"), y(e, t), setTimeout(function() {
                h(t)
            }, l), setTimeout(function() {
                e.parents(".cd-words-wrapper").addClass("is-loading")
            }, c)) : (y(e, t), setTimeout(function() {
                h(t)
            }, a))
        }

        function g(e, t) {
            e.parents(".cd-headline").hasClass("type") ? (v(e.find("i").eq(0), e, !1, t), e.addClass("is-visible").removeClass("is-hidden")) : e.parents(".cd-headline").hasClass("clip") && e.parents(".cd-words-wrapper").animate({
                width: e.width() + 10
            }, p, function() {
                setTimeout(function() {
                    h(e)
        ...
        }), e = s(".cd-headline"), r = a, e.each(function() {
            var e = s(this);
            if (e.hasClass("loading-bar")) r = l, setTimeout(function() {
    ...
    function(P, e) {
        P.fn.drawDoughnutChart = function(b, e) {
            ...
            var r, s = P('<svg width="' + t + '" height="' + i + '" viewBox="0 0 ' + t + " " + i + '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"></svg>').appendTo(n),
                ...
                C = (r = [i / 2, t / 2], Math.min.apply(null, r) - S.edgeOffset),
            ...
            for (var d, u, f, p = P('<div class="' + S.tipClass + '" />').appendTo("body").hide(), h = (p.width(), p.height(), 2 * (A - (C - A))), g = P('<div class="' + S.summaryClass + '" />').appendTo(n).css({
                    width: h + "px",
                    height: h + "px",
                    "margin-left": -h / 2 + "px",
                    "margin-top": -h / 2 + "px"
                }), N = (P('<p class="' + S.summaryTitleClass + '">' + S.summaryTitle + "</p>").appendTo(g), P('<p class="' + S.summaryNumberClass + '"></p>').appendTo(g).css({
                    opacity: 0
                })), v = 0, m = b.length; v < m; v++) O += b[v].value, E[v] = P(document.createElementNS("http://www.w3.org/2000/svg", "path")).attr({
            ...
            function y(e) {
                ...
                p.text(b[t].title + ": " + b[t].value + "%").fadeIn(200), S.onPathEnter.apply(P(this), [e, b])
            }

            function I(e) {
                p.hide(), S.onPathLeave.apply(P(this), [e, b])
            }
            ...
            return d = function(e) {
                ...
                if (n = e, o = O, N.css({
                        opacity: n
                    }).text((o * n).toFixed(1)), D.attr("opacity", e), 1 === b.length && 4.7122 < i * (b[0].value / O * (2 * T)) + t) return void E[0].attr("d", L(C, A));
                var n, o;
                for (var r = 0, s = b.length; r < s; r++) {
                    ...
                    E[r].attr("d", y.join(" ")), t += a
                }
            }, u = S.animation ? 1 / M(S.animationSteps, Number.MAX_VALUE, 1) : 1, f = S.animation ? 0 : 1, o(function() {
                var e, t, i;
                e = f += u, t = d, i = S.animation ? M(a(e), null, 0) : 1, t(i), f <= 1 ? o(arguments.callee) : S.afterDrawed.call(n)
            }), n
        }
    ...
    function(s) {
        ...
        s.scrollIt = function(e) {
            ...
            s(window).on("scroll", function() {
                ...
                e = t, n.onPageChange && e && o != e && n.onPageChange(e), o = e, s("[data-scroll-nav]").removeClass(n.activeClass), s("[data-scroll-nav=" + e + "]").addClass(n.activeClass)
            }).scroll(), s(window).on("keydown", function(e) {
                var t = e.which;
                return !(s("html,body").is(":animated") && (t == n.upKey || t == n.downKey) || (t == n.upKey && 0 < o ? (r(parseInt(o) - 1), 1) : t == n.downKey && o < i && (r(parseInt(o) + 1), 1)))
            }), s("body").on("click", "[data-scroll-nav], [data-scroll-goto]", function(e) {
                var t, i;
                e.preventDefault(), i = s((t = e).target).closest("[data-scroll-nav]").attr("data-scroll-nav") || s(t.target).closest("[data-scroll-goto]").attr("data-scroll-goto"), r(parseInt(i))
            })
        }
    }(jQuery),
    function() {
        ...
        function t(e) {
            return void 0 === this || Object.getPrototypeOf(this) !== t.prototype ? new t(e) : ((E = this).version = "3.4.0", E.tools = new n, E.isSupported() ? (E.tools.extend(E.defaults, e || {}), E.defaults.container = x(E.defaults), E.store = {
                elements: {},
                containers: []
        ...
        function i() {
            ...
            E.tools.forOwn(E.sequences, function(e) {
                o = E.sequences[e], i = !1;
                for (var t = 0; t < o.elemIds.length; t++) n = o.elemIds[t], f(E.store.elements[n]) && !i && (i = !0);
                o.active = i
            }), E.tools.forOwn(E.store.elements, function(e) {
                var t, i, n, o, r, s, a;
                c = E.store.elements[e], a = (s = c).config.useDelay, l = "always" === a || "onload" === a && !E.initialized || "once" === a && !s.seen,
                    function(e) {
                        if (e.sequence) {
                    ...
                    }(c) ? (c.config.beforeReveal(c.domEl), l ? c.domEl.setAttribute("style", c.styles.inline + c.styles.transform.target + c.styles.transition.delayed) : c.domEl.setAttribute("style", c.styles.inline + c.styles.transform.target + c.styles.transition.instant), u("reveal", c, l), c.revealing = !0, c.seen = !0, c.sequence && (t = c, i = l, o = n = 0, (r = E.sequences[t.sequence.id]).blocked = !0, i && "onload" === t.config.useDelay && (o = t.config.delay), t.sequence.timer && (n = Math.abs(t.sequence.timer.started - new Date), window.clearTimeout(t.sequence.timer)), t.sequence.timer = {
                        started: new Date
        ...
        function f(e) {
            var t, i, n, o, r, s, a, l, c, d = y(e.domEl),
                ...
                v = d.top,
                m = d.left;
            return i = v + h * p, n = m + g * p, o = v + h - h * p, r = m + g - g * p, s = f.y + e.config.viewOffset.top, a = f.x + e.config.viewOffset.left, l = f.y - e.config.viewOffset.bottom + u.height, c = f.x - e.config.viewOffset.right + u.width, i < l && s < o && n < c && a < r || "fixed" === window.getComputedStyle(e.domEl).position
        }
        ...
        t.prototype.defaults = {
            ...
            if (void 0 !== t && "number" == typeof t ? (i = t, t = {}) : null != t || (t = {}), o = x(t), u = o, !(r = "string" == typeof(d = e) ? Array.prototype.slice.call(u.querySelectorAll(d)) : E.tools.isNode(d) ? [d] : E.tools.isNodeList(d) ? Array.prototype.slice.call(d) : Array.isArray(d) ? d.filter(E.tools.isNode) : []).length) return E;
            i && "number" == typeof i && (c = _(), l = E.sequences[c] = {
                id: c,
                interval: i,
                elemIds: [],
                active: !1
            });
            for (var w = 0; w < r.length; w++)(a = r[w].getAttribute("data-sr-id")) ? s = E.store.elements[a] : (s = {
                id: _(),
                domEl: r[w],
                seen: !1,
                revealing: !1
            ...
            }, l.elemIds.push(s.id)), v = s, y = o, (m = t).container && (m.container = y), v.config ? v.config = E.tools.extendClone(v.config, m) : v.config = E.tools.extendClone(E.defaults, m), "top" === v.config.origin || "bottom" === v.config.origin ? v.config.axis = "Y" : v.config.axis = "X", h = s, void 0, g = window.getComputedStyle(h.domEl), h.styles || (h.styles = {
                transition: {},
                transform: {},
                computed: {}
            ...
            return !n && E.isSupported() && (b = {
                ...
                config: t,
                interval: i
            }, E.history.push(b), E.initTimeout && window.clearTimeout(E.initTimeout), E.initTimeout = window.setTimeout(S, 0)), E
    ...
    function(e, t) {
        ...
        var d, p, h, g = "object" == typeof window && window && window.Math == Math ? window : "object" == typeof self && self && self.Math == Math ? self : Function("return this")(),
            ...
            x = !v && !u(function() {
                return 7 != Object.defineProperty(("div", y ? m.createElement("div") : {}), "a", {
                    get: function() {
                        return 7
                    }
                }).a
            ...
            R = function(e, t) {
                var i;
                return l(e) && ("function" != typeof(i = e.constructor) || i !== Array && !l(i.prototype) ? a(i) && null === (i = i[W]) && (i = void 0) : i = void 0), new(void 0 === i ? Array : i)(0 === t ? 0 : t)
            },
            F = function(u, e) {
                var f = 1 == u,
                    p = 2 == u,
            ...
            G = {
                f: v ? K : function(e, t) {
                    if (e = Y(e), t = _(t, !0), x) try {
                        return K(e, t)
                    } catch (e) {}
                    if (Q(e, t)) return O(!V.f.call(e, t), e[t])
                }
            },
        ...
        var ce = {
                ...
                getterFor: function(i) {
                    return function(e) {
                        var t;
                        if (!a(e) || (t = p(e)).type !== i) throw TypeError("Incompatible receiver, " + i + " required");
                        return t
                    }
                }
            },
            de = c(function(e) {
                ...
                L("inspectSource", function(e) {
                    ...
                    var o = !!n && !!n.unsafe,
                        r = !!n && !!n.enumerable,
                        s = !!n && !!n.noTargetGet;
                    "function" == typeof i && ("string" != typeof t || Q(i, "name") || D(i, "name", t), a(i).source = l.join("string" == typeof t ? t : "")), e !== g ? (o ? !s && e[t] && (r = !0) : delete e[t], r ? e[t] = i : D(e, t, i)) : r ? e[t] = i : N(t, i)
            ...
            he = function(e, t) {
                var i, n = Y(e),
                    o = 0,
                    r = [];
                for (i in n) !Q(ie, i) && Q(n, i) && r.push(i);
                for (; t.length > o;) Q(n, i = t[o++]) && (~pe(r, i) || r.push(i));
                return r
            },
            ...
            De = function(e, t) {
                ...
                if (i = l ? g : c ? g[a] || N(a, {}) : (g[a] || {}).prototype)
                    for (n in t) {
                        if (r = t[n], o = e.noTargetGet ? (s = Oe(i, n)) && s.value : i[n], !Ae(l ? n : a + (c ? "." : "#") + n, e.forced) && void 0 !== o) {
                            if (typeof r == typeof o) continue;
                            xe(r, o)
                        }(e.sham || o && o.sham) && D(r, "sham", !0), de(i, n, r, e)
                    }
            },
            Ne = F(2);
        De({
                ...
                return function(e, t, i, n, o) {
                    ...
                    if (i < 2)
                        for (;;) {
                            ...
                            if (a <= (l += 1)) throw TypeError("Reduce of empty array with no initial value")
                        }
                    for (; l < a; l += 1) l in s && (n = t(n, s[l], l, r));
                    return n
        ...
        var We = Object.keys || function(e) {
            ...
            Fe = !Re || u(function() {
                ...
                for (var i = T(e), n = arguments.length, o = 1, r = ye.f, s = V.f; o < n;)
                    for (var a, l = w(arguments[o++]), c = r ? We(l).concat(r(l)) : We(l), d = c.length, u = 0; u < d;) s.call(l, a = c[u++]) && (i[a] = l[a]);
                return i
            } : Re;
        De({
            target: "Object",
        ...
        var ze = "\t\n\v\f\r                　\u2028\u2029\ufeff",
            ...
            Qe = 8 !== Ye(ze + "08") || 22 !== Ye(ze + "0x16") ? function(e, t) {
                var i, n = (i = String(e), i = (i = (i = String(f(i))).replace(Ue, "")).replace(Ve, ""));
        ...
        var Ke, Ge, Ze = RegExp.prototype.exec,
            ...
            et = Ze,
            tt = (Ke = /a/, Ge = /b*/g, Ze.call(Ke, "a"), Ze.call(Ge, "a"), 0 !== Ke.lastIndex || 0 !== Ge.lastIndex),
            it = void 0 !== /()??/.exec("")[1];
        (tt || it) && (et = function(e) {
            var t, i, n, o;
            ...
            }.call(this))), tt && (t = this.lastIndex), n = Ze.call(this, e), tt && n && (this.lastIndex = this.global ? n.index + n[0].length : t), it && n && 1 < n.length && Je.call(n[0], i, function() {
        ...
        var ot = function(e, t, i) {
                return t + (i ? (n = t, s = String(f(e)), a = S(n), l = s.length, a < 0 || l <= a ? "" : (o = s.charCodeAt(a)) < 55296 || 56319 < o || a + 1 === l || (r = s.charCodeAt(a + 1)) < 56320 || 57343 < r ? s.charAt(a) : s.slice(a, a + 2)).length : 1);
                var n, o, r, s, a, l
            },
            rt = function(e, t) {
                var i = e.exec;
            ...
            ct = function(i, e, t, n) {
                var o = q(i),
                    ...
                    s = r && !u(function() {
                        ...
                        return t.exec = function() {
                            return e = !0, null
                        }, "split" === i && (t.constructor = {}, t.constructor[st] = function() {
                            return t
                        }), t[o](""), !e
                    });
                if (!r || !s || "replace" === i && !at || "split" === i && !lt) {
                    var a = /./ [o],
                        ...
                        c = l[0],
                        d = l[1];
                    de(String.prototype, i, c), de(RegExp.prototype, o, 2 == e ? function(e, t) {
        ...
        ct("match", 1, function(n, c, d) {
            return [function(e) {
                ...
                var i = C(e),
                    n = String(this);
                if (!i.global) return rt(i, n);
                for (var o, r = i.unicode, s = [], a = i.lastIndex = 0; null !== (o = rt(i, n));) {
                    var l = String(o[0]);
                    "" === (s[a] = l) && (i.lastIndex = ot(n, E(i.lastIndex), r)), a++
                }
                return 0 === a ? null : s
            }]
        });
        ...
        for (var gt in ct("replace", 2, function(o, x, _) {
                return [function(e, t) {
                    ...
                    for (var d, u = "", f = 0, p = 0; p < l.length; p++) {
                        c = l[p];
                        for (var h = String(c[0]), g = dt(ut(S(c.index), o.length), 0), v = [], m = 1; m < c.length; m++) v.push(void 0 === (d = c[m]) ? d : String(d));
                        var y = c.groups;
                        if (r) {
                            var b = [h].concat(v, g, o);
                            void 0 !== y && b.push(y);
                            var w = String(t.apply(void 0, b))
                        } else w = k(h, o, g, v, y, t);
                        f <= g && (u += o.slice(f, g) + w, f = g + h.length)
                    }
                    return u + o.slice(f)
                }];
                ...
                function k(r, s, a, l, c, e) {
                    var d = a + r.length,
                        u = l.length,
                        t = ht;
                    return void 0 !== c && (c = T(c), t = pt), x.call(e, t, function(e, t) {
                        var i;
                        switch (t.charAt(0)) {
                            case "$":
                                return "$";
        ...
        function $t(e) {
            ...
            if ("symbol" == typeof(t = e) || t && "object" == typeof t && Dt.call(t) == xt) return wt;
            var t;
            if (jt(e)) {
        ...
        var Mt = function(e, t, i) {
                ...
                return jt(i) && (n = "leading" in i ? !!i.leading : n, o = "trailing" in i ? !!i.trailing : o),
                    function(n, o, e) {
                        var r, s, i, a, l, c, d = 0,
                            u = !1,
                            f = !1,
                            t = !0;
                        if ("function" != typeof n) throw new TypeError(bt);

                        function p(e) {
                            var t = r,
                                i = s;
                            return r = s = void 0, d = e, a = n.apply(i, t)
                        }
                        ...
                        function g() {
                            var e, t = It();
                            if (h(t)) return v(t);
                            l = setTimeout(g, (e = o - (t - c), f ? Lt(e, i - (t - d)) : e))
                        }

                        function v(e) {
                            return l = void 0, t && r ? p(e) : (r = s = void 0, a)
                        }
                        ...
                        function m() {
                            ...
                            if (r = arguments, s = this, c = t, i) {
                                if (void 0 === l) return d = e = c, l = setTimeout(g, o), u ? p(e) : a;
                                if (f) return l = setTimeout(g, o), p(c)
                            }
                            return void 0 === l && (l = setTimeout(g, o)), a
                        }
                        return o = $t(o) || 0, jt(e) && (u = !!e.leading, i = (f = "maxWait" in e) ? Nt($t(e.maxWait) || 0, o) : i, t = "trailing" in e ? !!e.trailing : t), m.cancel = function() {
                            void 0 !== l && clearTimeout(l), r = c = s = l = void(d = 0)
                        }, m.flush = function() {
        ...
        function Kt(e) {
            if ("number" == typeof e) return e;
            if ("symbol" == typeof(t = e) || t && "object" == typeof t && "[object Symbol]" == Ut.call(t)) return NaN;
            var t;
            if (Qt(e)) {
                var i = "function" == typeof e.valueOf ? e.valueOf() : e;
                e = Qt(i) ? i + "" : i
        ...
        var Gt, Zt = function(n, o, e) {
                ...
                function g() {
                    var e, t = Xt();
                    if (h(t)) return v(t);
                    l = setTimeout(g, (e = o - (t - c), f ? Yt(e, i - (t - d)) : e))
                }
                ...
                return o = Kt(o) || 0, Qt(e) && (u = !!e.leading, i = (f = "maxWait" in e) ? Vt(Kt(e.maxWait) || 0, o) : i, t = "trailing" in e ? !!e.trailing : t), m.cancel = function() {
                    void 0 !== l && clearTimeout(l), r = c = s = l = void(d = 0)
                }, m.flush = function() {
        ...
        function _i(e, t) {
            for (var i, n, o = e.length; o--;)
                if ((i = e[o][0]) === (n = t) || i != i && n != n) return o;
            return -1
        }
        ...
        function Ti(e, t) {
            ...
            return !Ei(i = r) || ui && ui in i || !(n = i, o = Ei(n) ? hi.call(n) : "", o == ti || o == ii || function(e) {
                var t = !1;
        ...
        function Si(o, r) {
            if ("function" != typeof o || r && "function" != typeof r) throw new TypeError(Jt);
            var s = function() {
                var e = arguments,
                ...
                return s.cache = i.set(t, n), n
            };
            return s.cache = new(Si.Cache || xi), s
        }
        ...
        bi.prototype.clear = function() {
            ...
            return this.__data__[e] = yi && void 0 === t ? ei : t, this
        }, wi.prototype.clear = function() {
            this.__data__ = []
        }, wi.prototype.delete = function(e) {
            var t = this.__data__,
                i = _i(t, e);
            return !(i < 0 || (i == t.length - 1 ? t.pop() : vi.call(t, i, 1), 0))
        ...
        var Ci = Si,
            ...
            ji = function() {
                ...
                return e.prototype.addObserver = function(e) {
                    ...
                    Oi && !this.connected_ && (document.addEventListener("transitionend", this.onTransitionEnd_), window.addEventListener("resize", this.refresh), Ii ? (this.mutationsObserver_ = new MutationObserver(this.refresh), this.mutationsObserver_.observe(document, {
                        attributes: !0,
                        childList: !0,
                        characterData: !0,
                        subtree: !0
        ...
        function Ri(e) {
            return Oi ? Wi(e) ? Fi(0, 0, (t = e.getBBox()).width, t.height) : function(e) {
                ...
                var n = Mi(e).getComputedStyle(e),
                    ...
                    a = Hi(n.width),
                    l = Hi(n.height);
                if ("border-box" === n.boxSizing && (Math.round(a + r) !== t && (a -= qi(n, "left", "right") + r), Math.round(l + s) !== i && (l -= qi(n, "top", "bottom") + s)), e !== Mi(e).document.documentElement) {
        ...
        var zi = function() {
                function e(e) {
                    this.broadcastWidth = 0, this.broadcastHeight = 0, this.contentRect_ = Fi(0, 0, 0, 0), this.target = e
                }
            ...
            Bi = function(e, t) {
                var i, n, o, r, s, a, l, c = (n = (i = t).x, o = i.y, r = i.width, s = i.height, a = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object, l = Object.create(a.prototype), $i(l, {
                    x: n,
                    y: o,
                    width: r,
                    height: s,
            ...
            Ki = function() {
                function l(e, t) {
                    ...
                    this.onScroll = function() {
                        ...
                        r.scrollbarWidth = yt(), r.hideNativeScrollbar()
                        ...
                        var t, i;
                        r.axis.x.scrollbar.rect = r.axis.x.scrollbar.el.getBoundingClientRect(), r.axis.y.scrollbar.rect = r.axis.y.scrollbar.el.getBoundingClientRect(), (r.axis.x.isOverflowing || r.axis.x.forceVisible) && (i = r.isWithinBounds(r.axis.x.scrollbar.rect)), (r.axis.y.isOverflowing || r.axis.y.forceVisible) && (t = r.isWithinBounds(r.axis.y.scrollbar.rect)), (t || i) && (e.preventDefault(), e.stopPropagation(), "mousedown" === e.type && (t && r.onDragStart(e, "y"), i && r.onDragStart(e, "x")))
                        ...
                        e.preventDefault(), e.stopPropagation(), r.el.classList.remove(r.classNames.dragging), document.removeEventListener("mousemove", r.drag), document.removeEventListener("mouseup", r.onEndDrag)
                    ...
                    }, this.el.SimpleBar || (this.recalculate = Mt(this.recalculate.bind(this), 64), this.onMouseMove = Mt(this.onMouseMove.bind(this), 64), this.hideScrollbars = Zt(this.hideScrollbars.bind(this), this.options.timeout), this.onWindowResize = Zt(this.onWindowResize.bind(this), 64, {
                        leading: !0
                    }), l.getRtlHelpers = Ci(l.getRtlHelpers), this.init())
                }
                ...
                return e.init = function() {
                    this.el.SimpleBar = this, Qi && (this.initDOM(), this.scrollbarWidth = yt(), this.recalculate(), this.initListeners())
                }, e.initDOM = function() {
                    var t = this;
                    ...
                    var t = this.contentWrapperEl[this.axis[e].scrollSizeAttr],
                        ...
                        a = ~~((i - o.size) * s);
                    a = "x" === e && this.isRtl && l.getRtlHelpers().isRtlScrollbarInverted ? a + (i - o.size) : a, o.el.style.transform = "x" === e ? "translate3d(" + a + "px, 0, 0)" : "translate3d(0, " + a + "px, 0)"
                    ...
                    if (this.offsetEl.style[this.isRtl ? "left" : "right"] = this.axis.y.isOverflowing || this.axis.y.forceVisible ? "-" + (this.scrollbarWidth || this.minScrollbarWidth) + "px" : 0, this.offsetEl.style.bottom = this.axis.x.isOverflowing || this.axis.x.forceVisible ? "-" + (this.scrollbarWidth || this.minScrollbarWidth) + "px" : 0, !this.scrollbarWidth) {
                        ...
                        this.contentWrapperEl.style[e] = this.axis.y.isOverflowing || this.axis.y.forceVisible ? this.minScrollbarWidth + "px" : 0, this.contentWrapperEl.style.paddingBottom = this.axis.x.isOverflowing || this.axis.x.forceVisible ? this.minScrollbarWidth + "px" : 0
                    }
                    ...
                    this.axis[t].dragOffset = n - i.getBoundingClientRect()[this.axis[t].offsetAttr], this.draggedAxis = t, this.el.classList.add(this.classNames.dragging), document.addEventListener("mousemove", this.drag), document.addEventListener("mouseup", this.onEndDrag)
    ...
    function(e) {
        ...
        jQuery("img.svg").each(function() {
            ...
            jQuery.get(e, function(e) {
                ...
                void 0 !== n && (t = t.attr("id", n)), void 0 !== o && (t = t.attr("class", o + " replaced-svg")), !(t = t.removeAttr("xmlns:a")).attr("viewBox") && t.attr("height") && t.attr("width") && t.attr("viewBox", "0 0 " + t.attr("height") + " " + t.attr("width")), i.replaceWith(t)
            }, "xml")
        })
    }),
    function(t) {
        ...
        t(".toggler__btn").on("click", function() {
            ...
            t(".switcher-gradient").removeClass("active"), t(".switcher-color").addClass("active"), t(".tab-gradient").removeClass("active"), t(this).addClass("active")
        }), t(".tab-gradient").on("click", function() {
            t(".switcher-color").removeClass("active"), t(".switcher-gradient").addClass("active"), t(".tab-color").removeClass("active"), t(this).addClass("active")
        }), t(".switcher-tab__color button").on("click", function() {
            var e = t(".tab-color-clone").find(".active");
            0 < e.length && t("body").removeClass(e.attr("data-theme")), t("body").addClass(t(this).attr("data-theme")), t(".switcher-tab__color button").removeClass("active"), t(this).addClass("active")
        }), t(".tab-full").on("click", function() {
            t(".switcher-boxed").removeClass("active"), t("body").removeClass("boxed-layout"), t(".tab-boxed").removeClass("active"), t(this).addClass("active")
        }), t(".tab-boxed").on("click", function() {
            t(".switcher-boxed").addClass("active"), t("body").addClass("boxed-layout"), t(".tab-full").removeClass("active"), t(this).addClass("active")
        }), t(".switcher-tab__pattern button").on("click", function() {
            var e = t(".switcher-boxed").find(".active");
            0 < e.length && t("body").removeClass(e.attr("data-theme")), t("body").addClass(t(this).attr("data-theme")), t(".switcher-tab__pattern button").removeClass("active"), t(this).addClass("active")
        })
    }(jQuery),
    function(x) {
        "use strict";
        ...
        x.fn.extend({
            venobox: function(e) {
                ...
                return w.cb_init(b), this.each(function() {
                    if ((K = x(this)).data("venobox")) return !0;

                    function t() {
                        F = K.data("gall"), H = K.data("numeratio"), I = K.data("gallItems"), j = K.data("infinigall"), $ = I || x('.vbox-item[data-gall="' + F + '"]'), z = $.eq($.index(K) + 1), B = $.eq($.index(K) - 1), z.length || !0 !== j || (z = $.eq(0)), 1 < $.length ? (G = $.index(K) + 1, T.html(G + " / " + $.length)) : G = 1, !0 === H ? T.show() : T.hide(), "" !== R ? S.show() : S.hide(), U = z.length || !0 === j ? (x(".vbox-next").css("display", "block"), !0) : (x(".vbox-next").css("display", "none"), !1), !0 !== (V = 0 < $.index(K) || !0 === j ? (x(".vbox-prev").css("display", "block"), !0) : (x(".vbox-prev").css("display", "none"), !1)) && !0 !== U || (A.on(l.DOWN, r), A.on(l.MOVE, s), A.on(l.UP, a))
                    }

                    function n(e) {
                        return !(e.length < 1) && !M && (M = !0, q = e.data("overlay") || e.data("overlaycolor"), N = e.data("framewidth"), L = e.data("frameheight"), E = e.data("border"), k = e.data("bgcolor"), O = e.data("href") || e.attr("href"), _ = e.data("autoplay"), R = e.attr(e.data("titleattr")) || "", e === B && A.addClass("animated").addClass("swipe-right"), e === z && A.addClass("animated").addClass("swipe-left"), X.show(), void A.animate({
                            opacity: 0
                        }, 500, function() {
                            W.css("background", q), A.removeClass("animated").removeClass("swipe-left").removeClass("swipe-right").css({
                                "margin-left": 0,
                                "margin-right": 0
                            }), "iframe" == e.data("vbtype") ? p() : "inline" == e.data("vbtype") ? g() : "ajax" == e.data("vbtype") ? f() : "video" == e.data("vbtype") ? h(_) : (A.html('<img src="' + O + '">'), v()), K = e, t(), M = !1, w.cb_after_nav(K, G, z, B)
                        }))
                    }

                    function i(e) {
                        27 === e.keyCode && o(), 37 == e.keyCode && !0 === V && n(B), 39 == e.keyCode && !0 === U && n(z)
                    }

                    function o() {
                        if (!1 === w.cb_pre_close(K, G, z, B)) return !1;
                        x("body").off("keydown", i).removeClass("vbox-open"), K.focus(), W.animate({
                            opacity: 0
                        }, 500, function() {
                            W.remove(), M = !1, w.cb_post_close()
                        })
                    }
                    b.VBclose = function() {
                        o()
                    }, K.addClass("vbox-item"), K.data("framewidth", w.framewidth), K.data("frameheight", w.frameheight), K.data("border", w.border), K.data("bgcolor", w.bgcolor), K.data("numeratio", w.numeratio), K.data("gallItems", w.gallItems), K.data("infinigall", w.infinigall), K.data("overlaycolor", w.overlayColor), K.data("titleattr", w.titleattr), K.data("venobox", !0), K.on("click", function(e) {
                        if (e.preventDefault(), K = x(this), !1 === w.cb_pre_open(K)) return !1;
                        switch (b.VBnext = function() {
                            n(z)
                        }, b.VBprev = function() {
                            n(B)
                        }, q = K.data("overlay") || K.data("overlaycolor"), N = K.data("framewidth"), L = K.data("frameheight"), _ = K.data("autoplay") || w.autoplay, E = K.data("border"), k = K.data("bgcolor"), M = V = U = !1, O = K.data("href") || K.attr("href"), D = K.data("css") || "", R = K.attr(K.data("titleattr")) || "", Y = '<div class="vbox-preloader">', w.spinner) {
                            case "rotating-plane":
                        ...
                        }), A.html(""), A.css("opacity", "0"), W.css("opacity", "0"), t(), W.animate({
                            opacity: 1
                        }, 250, function() {
                            "iframe" == K.data("vbtype") ? p() : "inline" == K.data("vbtype") ? g() : "ajax" == K.data("vbtype") ? f() : "video" == K.data("vbtype") ? h(_) : (A.html('<img src="' + O + '">'), v()), w.cb_post_open(K, G, z, B)
                        }), x("body").keydown(i), x(".vbox-prev").on("click", function() {
                            n(B)
                    ...
                    function r(e) {
                        A.addClass("animated"), te = ne = e.pageY, ie = oe = e.pageX, Z = !0
                    }

                    function s(e) {
                        if (!0 === Z) {
                            oe = e.pageX, ne = e.pageY, se = oe - ie, ae = ne - te;
                            var t = Math.abs(se);
                            t > Math.abs(ae) && t <= 100 && (e.preventDefault(), A.css("margin-left", se))
                        }
                    }
                    ...
                    function a(e) {
                        if (!0 === Z) {
                            var t = K,
                                i = Z = !1;
                            (re = oe - ie) < 0 && !0 === U && (t = z, i = !0), 0 < re && !0 === V && (t = B, i = !0), Math.abs(re) >= le && !0 === i ? n(t) : A.css({
                                "margin-left": 0,
                                "margin-right": 0
                            })
                        }
                    }
                    w.overlayClose || (e = ".vbox-close"), x("body").on("click touchstart", e, function(e) {
                    ...
                    var l = {
                        ...
                        d = function(e) {
                            ...
                            i = t == l.UP ? u(t, e, null, null) : u(t, e, n.pageX, n.pageY), x(e.target).trigger(i)
                        },
                        u = function(e, t, i, n) {
                            return x.Event(e, {
                                pageX: i,
                    ...
                    function f() {
                        x.ajax({
                            ...
                            A.html('<div class="vbox-inline">' + e + "</div>"), v()
                        }).fail(function() {
                            A.html('<div class="vbox-inline"><p>Error retrieving contents, please retry</div>'), m()
                        })
                    }

                    function p() {
                        A.html('<iframe class="venoframe" src="' + O + '"></iframe>'), m()
                    }
                    ...
                    function h(e) {
                        var t, i, n = (O.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/), -1 < RegExp.$3.indexOf("youtu") ? i = "youtube" : -1 < RegExp.$3.indexOf("vimeo") && (i = "vimeo"), {
                            ...
                            o = (e ? "?rel=0&autoplay=1" : "?rel=0") + function(e) {
                                ...
                                if (void 0 !== i[1]) {
                                    var n, o, r = i[1].split("&");
                                    for (o = 0; o < r.length; o++) t = t + "&" + (n = r[o].split("="))[0] + "=" + n[1]
                                }
                                return encodeURI(t)
                            }();
                        "vimeo" == n.type ? t = "https://player.vimeo.com/video/" : "youtube" == n.type && (t = "https://www.youtube.com/embed/"), A.html('<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay" frameborder="0" src="' + t + n.id + o + '"></iframe>'), m()
                    }

                    function g() {
                        A.html('<div class="vbox-inline">' + x(O).html() + "</div>"), m()
                    }
                    ...
                    function m() {
                        S.html(R), A.find(">:first-child").addClass("figlio").css({
                            width: N,
                            height: L,
                            padding: E,
                            background: k
                    ...
                    function y() {
                        var e = A.outerHeight(),
                            t = x(window).height();
                        P = e + 60 < t ? (t - e) / 2 : "30px", A.css("margin-top", P), A.css("margin-bottom", P), w.cb_post_resize()
                    }
                    "ontouchstart" in window ? (x(document).on("touchstart", d), x(document).on("touchmove", d), x(document).on("touchend", d)) : (x(document).on("mousedown", c), x(document).on("mouseup", c), x(document).on("mouseout", c), x(document).on("mousemove", c)), x(window).resize(function() {
